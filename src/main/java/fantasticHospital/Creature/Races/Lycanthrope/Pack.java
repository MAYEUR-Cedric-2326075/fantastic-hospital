...
public class Pack {
    ...
    public LycanthropeMale reproduice() {
        return (LycanthropeMale)couple.reproduise();
    }
    ...
    private void updateAlphaFemale() {
        if (ranking.size() > 0) {
...
////////////////////////////////////////////////////////////////////////////////////
    private void updateAlphaMale(LycanthropeMale lycanthrope) {
    ...
    private boolean challengeAlpha(LycanthropeMale challenger) {
